    ...
    public class StarBehavior : Behavior<View>
    {
        ...
        public static readonly BindableProperty RatingProperty =
           BindableProperty.Create("Rating",
                                   typeof(int?),
                                   typeof(StarBehavior), default(int?), propertyChanged:OnRatingChanged);
        ...
        static void OnRatingChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            int? newRatingValue = (int?)newValue;
            ...
            {
                item.IsStarred = newRatingValue.HasValue && newRatingValue.Value <= count;
