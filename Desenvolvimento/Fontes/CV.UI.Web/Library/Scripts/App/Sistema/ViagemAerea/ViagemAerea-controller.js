(function () {
	...
	angular
		.module('Sistema')
		.controller('ViagemAereaCtrl',['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService','Viagem','ViagemAerea', ViagemAereaCtrl]);

	function ViagemAereaCtrl($uibModal,  Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService,Viagem,ViagemAerea) {
		var vm = this;
        ...
        vm.ActionModalCtrl = function ($uibModalInstance, item, index) {
            ...
            vmAction.edit = function (idToEdit) {
                $uibModalInstance.close();
                $state.go('ViagemAereaEdicao', { id: idToEdit, filtro: vm.filtroAtualizacao });
            };
...
//
        vm.gridOptions = {
            data: 'itemViagemAerea.ListaDados',           
            			columnDefs: [
				{field:'Identificador',  displayName: '', cellTemplate: "BotoesGridTemplate.html",  width: 60,},
				{field:'IdentificadorViagem', displayName: $translate.instant('ViagemAerea_IdentificadorViagem'),},
				{field:'CompanhiaAerea', displayName: $translate.instant('ViagemAerea_CompanhiaAerea'),},
				{field:'DataPrevista', displayName: $translate.instant('ViagemAerea_DataPrevista'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'DataInicio', displayName: $translate.instant('ViagemAerea_DataInicio'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'DataFim', displayName: $translate.instant('ViagemAerea_DataFim'),cellFilter: 'date:\'dd/MM/yyyy\'' },
			],
