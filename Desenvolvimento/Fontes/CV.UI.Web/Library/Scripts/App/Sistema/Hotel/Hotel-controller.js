(function () {
	...
	angular
		.module('Sistema')
		.controller('HotelCtrl',['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService','Cidade','Viagem','Hotel', HotelCtrl]);

	function HotelCtrl($uibModal,  Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService,Cidade,Viagem,Hotel) {
		var vm = this;
        ...
        vm.ActionModalCtrl = function ($uibModalInstance, item, index) {
            ...
            vmAction.edit = function (idToEdit) {
                $uibModalInstance.close();
                $state.go('HotelEdicao', { id: idToEdit, filtro: vm.filtroAtualizacao });
            };
...
//
        vm.gridOptions = {
            data: 'itemHotel.ListaDados',           
            			columnDefs: [
				{field:'Identificador',  displayName: '', cellTemplate: "BotoesGridTemplate.html",  width: 60,},
				{field:'IdentificadorViagem', displayName: $translate.instant('Hotel_IdentificadorViagem'),},
				{field:'IdentificadorCidade', displayName: $translate.instant('Hotel_IdentificadorCidade'),},
				{field:'Nome', displayName: $translate.instant('Hotel_Nome'),},
				{field:'CodigoPlace', displayName: $translate.instant('Hotel_CodigoPlace'),},
				{field:'DataEntrada', displayName: $translate.instant('Hotel_DataEntrada'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'DataSaidia', displayName: $translate.instant('Hotel_DataSaidia'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'Longitude', displayName: $translate.instant('Hotel_Longitude'),cellFilter: 'number:\'8\'' },
				{field:'Latitude', displayName: $translate.instant('Hotel_Latitude'),cellFilter: 'number:\'8\'' },
				{field:'EntradaPrevista', displayName: $translate.instant('Hotel_EntradaPrevista'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'SaidaPrevista', displayName: $translate.instant('Hotel_SaidaPrevista'),cellFilter: 'date:\'dd/MM/yyyy\'' },
			],
