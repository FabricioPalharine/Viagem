(function () {
	...
	angular
		.module('Sistema')
		.controller('RefeicaoCtrl',['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService','Cidade','Viagem','Atracao','Refeicao', RefeicaoCtrl]);

	function RefeicaoCtrl($uibModal,  Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService,Cidade,Viagem,Atracao,Refeicao) {
		var vm = this;
        ...
        vm.ActionModalCtrl = function ($uibModalInstance, item, index) {
            ...
            vmAction.edit = function (idToEdit) {
                $uibModalInstance.close();
                $state.go('RefeicaoEdicao', { id: idToEdit, filtro: vm.filtroAtualizacao });
            };
...
//
        vm.gridOptions = {
            data: 'itemRefeicao.ListaDados',           
            			columnDefs: [
				{field:'Identificador',  displayName: '', cellTemplate: "BotoesGridTemplate.html",  width: 60,},
				{field:'IdentificadorViagem', displayName: $translate.instant('Refeicao_IdentificadorViagem'),},
				{field:'IdentificadorCidade', displayName: $translate.instant('Refeicao_IdentificadorCidade'),},
				{field:'Nome', displayName: $translate.instant('Refeicao_Nome'),},
				{field:'CodigoPlace', displayName: $translate.instant('Refeicao_CodigoPlace'),},
				{field:'Data', displayName: $translate.instant('Refeicao_Data'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'Latitude', displayName: $translate.instant('Refeicao_Latitude'),cellFilter: 'number:\'8\'' },
				{field:'Longitude', displayName: $translate.instant('Refeicao_Longitude'),cellFilter: 'number:\'8\'' },
				{field:'Tipo', displayName: $translate.instant('Refeicao_Tipo'),},
				{field:'IdentificadorAtracao', displayName: $translate.instant('Refeicao_IdentificadorAtracao'),},
			],
