(function () {
    ...
    angular
		.module('Sistema')
		.controller('LocaisHotelCtrl', ['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService', 'Viagem', 'Consulta', 'Dominio', LocaisHotelCtrl]);

    function LocaisHotelCtrl($uibModal, Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService, Viagem, Consulta, Dominio, SignalR) {
        var vm = this;
        ...
        vm.CarregarDadosWebApi = function () {
            ...
            Consulta.CarregarDetalhesHotel({ json: JSON.stringify(FiltroConsulta) }, function (data) {
                vm.loading = false;
