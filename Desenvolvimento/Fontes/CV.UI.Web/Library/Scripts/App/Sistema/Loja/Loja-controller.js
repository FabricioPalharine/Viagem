(function () {
	...
	angular
		.module('Sistema')
		.controller('LojaCtrl',['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService','Viagem','Atracao','Loja', LojaCtrl]);

	function LojaCtrl($uibModal,  Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService,Viagem,Atracao,Loja) {
		var vm = this;
        ...
        vm.ActionModalCtrl = function ($uibModalInstance, item, index) {
            ...
            vmAction.edit = function (idToEdit) {
                $uibModalInstance.close();
                $state.go('LojaEdicao', { id: idToEdit, filtro: vm.filtroAtualizacao });
            };
...
//
        vm.gridOptions = {
            data: 'itemLoja.ListaDados',           
            			columnDefs: [
				{field:'Identificador',  displayName: '', cellTemplate: "BotoesGridTemplate.html",  width: 60,},
				{field:'IdentificadorViagem', displayName: $translate.instant('Loja_IdentificadorViagem'),},
				{field:'Nome', displayName: $translate.instant('Loja_Nome'),},
				{field:'Latitude', displayName: $translate.instant('Loja_Latitude'),cellFilter: 'number:\'8\'' },
				{field:'Longitude', displayName: $translate.instant('Loja_Longitude'),cellFilter: 'number:\'8\'' },
				{field:'CodigoPlace', displayName: $translate.instant('Loja_CodigoPlace'),},
				{field:'Data', displayName: $translate.instant('Loja_Data'),cellFilter: 'date:\'dd/MM/yyyy\'' },
				{field:'IdentificadorAtracao', displayName: $translate.instant('Loja_IdentificadorAtracao'),},
			],
