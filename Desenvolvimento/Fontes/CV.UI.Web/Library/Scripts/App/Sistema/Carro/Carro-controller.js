(function () {
	...
	angular
		.module('Sistema')
		.controller('CarroCtrl',['$uibModal', 'Error', '$timeout', '$state', '$translate', '$scope', 'Auth', '$rootScope', '$stateParams', '$window', 'i18nService','Viagem','Carro', CarroCtrl]);

	function CarroCtrl($uibModal,  Error, $timeout, $state, $translate, $scope, Auth, $rootScope, $stateParams, $window, i18nService,Viagem,Carro) {
		var vm = this;
        ...
        vm.ActionModalCtrl = function ($uibModalInstance, item, index) {
            ...
            vmAction.edit = function (idToEdit) {
                $uibModalInstance.close();
                $state.go('CarroEdicao', { id: idToEdit, filtro: vm.filtroAtualizacao });
            };
...
//
        vm.gridOptions = {
            data: 'itemCarro.ListaDados',           
            			columnDefs: [
				{field:'Identificador',  displayName: '', cellTemplate: "BotoesGridTemplate.html",  width: 60,},
				{field:'IdentificadorViagem', displayName: $translate.instant('Carro_IdentificadorViagem'),},
				{field:'Locadora', displayName: $translate.instant('Carro_Locadora'),},
				{field:'Modelo', displayName: $translate.instant('Carro_Modelo'),},
				{field:'KM', displayName: $translate.instant('Carro_KM'),},
				{field:'Alugado', displayName: $translate.instant('Carro_Alugado'),},
			],
