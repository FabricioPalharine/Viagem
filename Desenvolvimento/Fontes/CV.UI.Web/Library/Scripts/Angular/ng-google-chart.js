...
(function () {
    angular.module('googlechart')
        .directive('agcOnClick', onSelectDirective);
        ...
        return {
            ...
            link: function (scope, element, attrs, googleChartController) {
                ...
                function callback(args, chart, chartWrapper){
                    ...
                    var clickEventRetParams = { targetID: args[0] };
                    // This is for backwards compatibility for people using 'selectedItem' that only wanted the first selection.
                    clickEventRetParams.chartWrapper = chartWrapper;
                    clickEventRetParams.chart = chart;
                    scope.$apply(function () {
                        scope.$eval(attrs.agcOnClick, { clickEventRetParams: clickEventRetParams });
                    });
                }
