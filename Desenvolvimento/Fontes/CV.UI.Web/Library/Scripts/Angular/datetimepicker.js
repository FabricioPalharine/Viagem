                  ...
                  var dataFactory = {
                      ...
                      month: function month(unixDate) {
                          ...
                          for (var i = 0; i < 12; i += 1) {
                              ...
                              var dateValue = {
                                  ...
                                  'display': monthMoment.locale(configuration.langCode).format('MMM'),
                                  'active': monthMoment.locale(configuration.langCode).format('YYYY-MMM') === activeDate
                              };
                      ...
                      day: function day(unixDate) {
                          ...
                          var result = {
                              ...
                              'previousViewDate': new DateObject({
                                  utcDateValue: previousViewDate.valueOf(),
                                  display: startOfMonth.locale(configuration.langCode).format('YYYY-MMM')
                              }),
                          ...
                          for (var dayNumber = 0; dayNumber < 7; dayNumber += 1) {
                              result.dayNames.push(moment.utc().weekday(dayNumber).locale(configuration.langCode).format('dd'));
                          }
                          ...
                          for (var i = 0; i < 6; i += 1) {
                              ...
                              for (var j = 0; j < 7; j += 1) {
                                  ...
                                  var dateValue = {
                                      'utcDateValue': monthMoment.valueOf(),
                                      'display': monthMoment.locale(configuration.langCode).format('D'),
