...
namespace CV.Data.Configuration
{
    public partial class HotelEventoConfiguration : EntityTypeConfiguration<HotelEvento>
    {
        public HotelEventoConfiguration()
        {
            ...
            this.Property(i => i.LatitudeEntrada).HasColumnName("NR_LATITUDE_ENTRADA");
            this.Property(i => i.LatitudeSaida).HasColumnName("NR_LATITUDE_SAIDA");
            this.Property(i => i.LongitudeEntrada).HasColumnName("NR_LONGITUDE_ENTRADA");
            this.Property(i => i.LongitudeSaida).HasColumnName("NR_LONGITUDE_SAIDA");
